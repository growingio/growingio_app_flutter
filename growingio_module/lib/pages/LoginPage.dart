...
class _LoginPageState extends State<LoginPage> {
  ...
  void setDataCollectionEnabled() async {
    const platform = const MethodChannel("setDataCollectionEnabled");
    String returnValue = await platform.invokeMethod("true");
    print("setDataCollectionEnabled result："+returnValue);
         ...
         Expanded(
             child: Row(
                 ...
                 MaterialButton(
                   ...
                   minWidth: 1,
                   //height: 20.0,
                   child: Text('我已阅读并同意《用户协议》', style: TextStyle(color: Colors.black54, fontSize: 12.0),),
                   onPressed: () {
                     SetPageData.path = 'images/file/user.html';
                     Navigator.push(
                         context,
                   ...
                   MaterialButton(
                     ...
                     minWidth: 1,
                     //height: 20.0,
                       child: Text('《隐私政策》', style: TextStyle(color: Colors.black54, fontSize: 12.0),),
                       onPressed: () {
                         SetPageData.path = 'images/file/privacy.html';
                         Navigator.push(
                             context,
                             MaterialPageRoute(builder: (context) =>  GioWebView()));
                       },
